        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_UserId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_Address_UserId1",
                        column: x => x.Address_UserId1,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "ASUS" },
                    { 2, null, "Lenovo" },
                    { 3, null, "Microsoft Xbox" },
                    { 4, null, "Sony PlayStation" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Computers & Tablets" },
                    { 2, null, "Game Consoles" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "ASUS ROG Strix G35CZ Gaming Desktop PC, GeForce RTX 2080 SUPER, Factory Overclocked Intel Core i9-10900KF, 32GB DDR4 RAM, 1TB PCIe SSD, Dual Hot-Swap SSD Bays, Windows 10 Professional, G35CZ-XB982", "ASUS ROG Strix G35CZ Gaming Desktop PC", "images/products/pc1.jpg", 6500m, 1, 1 },
                    { 2, "Lenovo Legion 5 Desktop PC Computer | 10th Gen Intel Core i7-10700 | 16GB RAM | 512GBSSD +2TBHDD | NVIDIA GeForce RTX 2060 | Wi-Fi 6 | HDMI | Keyboard and Mouse | Windows 10", "Lenovo Legion 5 Desktop PC Computer", "images/products/pc2.jpg", 2500m, 2, 1 },
                    { 3, "Make the most of every gaming minute with Quick Resume, lightning-fast load times, and gameplay of up to 120 FPS—all powered by Xbox Velocity Architecture.", "Xbox Series S", "images/products/console1.jpg", 350m, 3, 2 },
                    { 4, "Lightning Speed - Harness the power of a custom CPU, GPU, and SSD with Integrated I/O that rewrite the rules of what a PlayStation console can do", "PlayStation 5 Console", "images/products/console2.jpg", 400m, 4, 2 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Address_UserId1",
                table: "AspNetUsers",
                column: "Address_UserId1");
